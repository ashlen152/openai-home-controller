...
void updateDisplayStatus()
{
  ...
  display.setContextNormal(ctx.pumpEnabled, ctx.value, ctx.currentTime, ctx.autodosingEnabled, ctx.nextSchedule, ctx.totalVolume, ctx.stepsPerML, ctx.activeProfile);
