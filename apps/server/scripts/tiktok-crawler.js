...
${c.cyan}Examples:${c.reset}
  ...
  node scripts/tiktok-crawler.js scrape https://www.tiktok.com/@cuxi037

  # Download all photos
  node scripts/tiktok-crawler.js photos cuxi037_urls.json

  # Record all videos
  node scripts/tiktok-crawler.js videos cuxi037_urls.json
